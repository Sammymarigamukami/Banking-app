...
const loans: Loan[] = [
  ...
  },
  {
    ...
    customerName: 'Michael Chen',
    type: 'home',
    amountRequested: 350000.00,
    amountApproved: 340000.00,
    duration: 360,
    interestRate: 3.8,
    status: 'active',
...
const fraudAlerts: FraudAlert[] = [
  {
    ...
    amount: 15000.00,
    date: '2024-03-15',
    description: 'Large withdrawal from card in foreign country',
  },
  {
    id: 'fraud_002',
    ...
    riskLevel: 'high',
    date: '2024-03-15',
    description: '7 failed login attempts in 2 hours',
  },
  {
    id: 'fraud_003',
    accountNumber: 'ACC001234',
    ...
    riskLevel: 'medium',
    date: '2024-03-14',
    description: 'Transaction from IP in different country',
  },
  {
    id: 'fraud_004',
    accountNumber: 'ACC001235',
